...
grupos = r'C:\Files\DADOS LEITURAS TEMPO REAL\BASES\Grupos_Mes_UNMT.csv'
grupos_hoje = r'C:\Files\DADOS LEITURAS TEMPO REAL\BASES\GruposTempoRealUNMT.csv'
grupos_dia = r"C:\Tools\pentaho\Repositorio\LeiturasTempoReal\HISTORICO CONSORCIO\GRUPOS\UNMT\DIARIO\GRUPOS_UNMT.csv"
arq_exec = r'C:\Files\DADOS LEITURAS TEMPO REAL\UNMT\UNMT_TESTE\LeituraUNMT.csv'
output_csv_path = r"C:\Files\DADOS LEITURAS TEMPO REAL\BASES\LeiturasTempoRealUNMT.csv"
...
def parse_soap_response(response):
    ...
    pega_execucao_result = root.find(".//{ENDERECO}PegaExecucaoResult")
